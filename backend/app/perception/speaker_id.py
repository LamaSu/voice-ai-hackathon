...
MEMORY_PARAMS = dict(
    ...
    min_first_speaker_seconds=0.9,
    min_new_speaker_seconds=1.2,
    late_new_speaker_min_seconds=2.0,
    max_speakers=3,  # capped:each extra profile costs ECAPA scoring on every live window
    min_margin=0.0372,
